...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/member/skins/sketchbook5_member_skin','common_header.html') ?>
...
if($__Context->formTag->name != 'signature'){ ?><div class="control-group">
		...
		<div class="btnArea group"><div class="btn-group pull-right">
			...
			<a href="<?php echo getUrl('act','','member_srl','') ?>" class="btn"><?php echo $__Context->lang->cmd_cancel ?></a>
		</div></div>
	</form>
</div>
